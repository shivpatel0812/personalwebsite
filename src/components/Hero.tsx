          ...
          <div className="text-center lg:text-left space-y-6 lg:space-y-8 order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Link
                ...
                className="bg-gradient-to-r from-[#0077B5] to-[#005885] text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-[#0077B5]/25 hover-glow text-center text-sm md:text-base flex items-center justify-center gap-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
