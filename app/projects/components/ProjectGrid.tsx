...
const ProjectGrid: React.FC<ProjectGridProps> = ({
  ...
  return (
    <div className="w-full">
      {/* Horizontal scrolling layout for wide screens */}
        ...
        <div className="flex justify-center overflow-x-auto">
          <div className="flex gap-8 pb-4 px-4">
            {projects.map((project, index) => (
              <div
                key={index}
                className="group bg-gray-800/80 rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer hover:scale-[1.02] border border-gray-700/50 hover:border-blue-500/50 w-80 flex-shrink-0"
      ...
      <div className="lg:hidden grid grid-cols-1 md:grid-cols-2 gap-8 max-w-7xl mx-auto">
        {projects.map((project, index) => (
          <div
            key={index}
